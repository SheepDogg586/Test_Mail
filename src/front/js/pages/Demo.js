...
export const Demo = () => {
	...
	return (
		<div className="Equipment" style={{backgroundImage:'url("https://images.pexels.com/photos/66258/staniel-cay-swimming-pig-seagull-fish-66258.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1")', backgroundSize:'cover'}}>
